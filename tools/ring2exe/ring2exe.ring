...
/*
	Usage
		...
		filename_buildgcc.sh (Will be executed to build filename.c using GNU C/C++)
		filename_buildclang.sh (Will be executed to build filename.c using CLang C/C++)
		filename.obj	  (Will be generated by the Visual C/C++ compiler) 
		filename.exe 	  (Will be generated by the Visual C/C++ Linker)
		filename	  (Executable File - On Linux, macOS & FreeBSD platforms)
